...
//               <div className="aspect-square bg-white/70 rounded-lg overflow-hidden backdrop-blur-sm">
//                 <img 
//                   src={product.image} 
//                   alt={product.name}
...
//             <div>
//               <div className="mb-6">
//                 <p className="text-sm text-gray-700 mb-2 arabic-body">
//                   {content.category} {product.category}
//                 </p>
//                 <h1 className="text-4xl font-bold text-gray-900 mb-4 arabic-heading-font">
//                   {product.name}
//                 </h1>
...
//                     <span className="text-xl text-gray-500 line-through arabic-heading-font">
...
//                 {/* Size Selection */}
//                 <div className="mb-6">
//                   <label className="block text-sm font-semibold text-gray-700 mb-3 arabic-body">
//                     {content.size}
//                   </label>
...
//                         className={`px-4 py-2 rounded border-2 transition-colors arabic-body ${
...
//                     className="flex-1 bg-primary hover:bg-primary/90 text-white px-6 py-3 rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 space-x-reverse arabic-body"
//                   >
      ...
      <div className="w-md px-4 md:px-6 lg:px-8 section-padding relative z-10 mt-0">
        ...
        <div className="rounded-lg shadow-lg overflow-hidden max-w-7xl mx-auto bg-cover bg-center bg-no-repeat relative" >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 p-7 relative z-10">
            ...
            {/* Product Images */}
            <div className="space-y-4">
              <div className="aspect-square bg-white/70 rounded-sm overflow-hidden ">
                <img 
                  src={product.image} 
                  alt={product.name}
                  className="w-full h-full object-cover"
